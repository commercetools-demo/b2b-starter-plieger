  ...
  return (
    <div>
      ...
      <div className="bg-white rounded-xl border border-gray-100 p-6">
        <Table columns={columns} data={flows} loading={loading} emptyMessage="No approval flows found." onRowClick={(row: any) => router.push(localePath(`/dashboard/approval-flows/${row.id}`))} />
        {total > LIMIT && (
          <div className="mt-6">
