  ...
  if (!rule) {
    return (
      <div className="text-center py-10">
        ...
        <Button variant="secondary" href={localePath('/dashboard/approval-rules')}>← Back</Button>
      </div>
    );
  }
  ...
  return (
    <div>
      <div className="flex items-center gap-4 mb-6">
        <Button variant="secondary" href={localePath('/dashboard/approval-rules')} size="sm">← Back</Button>
