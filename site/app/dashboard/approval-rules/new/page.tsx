...
export default function CreateApprovalRulePage() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      router.push('/dashboard/approval-rules');
    } catch (e: any) {
  ...
  return (
    <div className="max-w-3xl">
      <Button variant="ghost" size="sm" href="/dashboard/approval-rules" className="mb-4">
      ...
      <div className="space-y-6">
        ...
        <div className="flex gap-3 pt-2">
          ...
          <Button variant="ghost" href="/dashboard/approval-rules">
            Cancel
          </Button>
        </div>
      </div>
