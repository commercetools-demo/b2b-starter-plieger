...
export default function ApprovalFlowDetailPage() {
  ...
  if (!flow) {
    return (
      <div className="text-center py-16">
        ...
        <Button variant="primary" href="/dashboard/approval-flows">Back to Flows</Button>
      </div>
    );
  }
  ...
  return (
    <div>
      <Button variant="ghost" size="sm" href="/dashboard/approval-flows" className="mb-4">&larr; Back to Approval Flows</Button>
